<?php 
return [
  'old_installation_has_data' => 'پایگاه داده شما خالی نیست! شاید مقداری داده از نصب قبلی شما باقی بماند. برای نصب جدید، می توانید پایگاه داده خود را خالی کرده و مجوز را مجدداً نصب کنید. برای حفظ اطلاعات قدیمی می توانید به صفحه ورود به سیستم بروید. همچنین می توانید داده های آزمایشی را تازه وارد کنید.',
  'title' => 'نصب zCart',
  'next' => 'گام بعدی',
  'back' => 'قبلی',
  'finish' => 'نصب',
