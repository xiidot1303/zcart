<?php 
return [
  'custom_css_help_text' => 'CSS استایل دلخواه خود را در کادر اضافه کنید. این کار طراحی تم را لغو می کند.',
  'custom_css_guideline_for_merchant' => 'با اعمال سبک های CSS سفارشی خود، ظاهر صفحه نمایه خود را به راحتی سفارشی کنید. با استفاده از مراحل زیر، رنگ نام فروشگاه خود را تنظیم کنید و اندازه لوگوی خود را بدون زحمت تغییر دهید.',
  'custom_css_guideline' => 'اگر می خواهید رنگ پس زمینه نوار ناوبری اصلی و دکمه جستجو و پاورقی ها را تغییر دهید، این روشی است که می توانید این کار را انجام دهید.',
  'trust_badge_size' => 'اندازه تصویر نشان اعتماد باید 32x32px و png. باشد',
  ...
  'country_iso_code' => 'کد ISO 3166_2. برای مثال ، مثال: کد مربوط به ایالات متحده آمریکا کد ایالات متحده است',
  ...
  'featured_img_size' => 'اندازه تصویر ویژه باید 285x190px باشد',
  'brand_featured_img_size' => 'اندازه تصویر ویژه باید 380x160px باشد',
  'featured_image' => 'این تصویر در بخش دسته ویژه در صفحه اصلی نشان داده خواهد شد',
  'brand_featured_image' => 'این تصویر در بخش مارک های ویژه در صفحه اصلی نشان داده می شود',
  ...
  'product_slug' => 'این به عنوان URL محصول شما استفاده می شود، بعداً نمی توانید آن را تغییر دهید. برای انتخاب حلزون برای محصول خود خلاق باشید',
  ...
  'payout_bank_info' => 'اطلاعات بانکی شما به شما کمک می کند تا پرداخت خود را از بازار دریافت کنید.',
  'account_type' => 'نوع حساب بانکی خود مانند ذخیره، جاری، چک کردن و غیره.',
  'account_routing_number' => 'شماره مسیریابی یک کد نه رقمی است که برای شناسایی یک موسسه مالی استفاده می شود',
  'account_swift_bic_code' => 'یک کد SWIFT/BIC بانک ها و موسسات مالی را در سطح جهانی شناسایی می کند.',
  'account_iban' => 'برای اکثر انواع پرداخت ها، فرستندگان باید از شماره IBAN شما استفاده کنند.',
  ...
  'slider_description' => 'چند کلمه بیشتر در مورد لغزنده وجود دارد. اگر نمی خواهید توضیحات را نشان دهید ، آن را خالی بگذارید.',
  ...
  'slider_img_hint_made_in_china' => 'تصویر کشویی باید 780x400 پیکسل باشد',
  ...
  'active_business_zone' => 'منطقه عملیاتی کار شما فروشندگان فقط در مناطق فعال می توانند مناطق حمل و نقل ایجاد کنند.',
  'config_show_seo_info_to_frontend' => 'نمایش اطلاعات SEO مانند عنوان متا ، توضیحات متا ، برچسب ها به قسمت جلویی.',
  'config_can_use_own_catalog_only' => 'در صورت فعال بودن ، فروشندگان می توانند فقط از محصولات کاتالوگ خود برای ایجاد لیست استفاده کنند.',
  'currency_iso_numeric' => 'کد عددی ایزو 4217. به عنوان مثال: USD = 840 و JPY = 392',
  'country_iso_numeric' => 'کد عددی ISO 3166-1. به عنوان مثال: USA = 840 و JAPAN = 392',
  'currency_active' => 'ارزهای فعال در بازار نشان داده می شوند.',
  'country_active' => 'ارزهای فعال در منطقه تجاری گنجانده می شوند.',
  'currency_symbol' => 'نماد ارز',
  'currency_disambiguate_symbol' => 'مثال: USD = دلار آمریکا و BDT = BD $',
  'currency_html_entity' => 'مثال: JPY = ¥ و INR =',
  'currency_smallest_denomination' => 'کوچکترین فرض ارز. مقدار پیش فرض 1 است',
  'currency_subunit_to_unit' => 'تعداد واحدهای زیر واحد برای یک واحد واحد نیاز دارد. مقدار پیش فرض 100 است',
  'eea' => 'منطقه اقتصادی اروپا',
  'support_agent' => 'نماینده پشتیبانی همه اعلان های پشتیبانی را دریافت می کند. در صورت عدم تنظیم ، بازرگان همه اعلان ها را دریافت می کند.',
  'show_refund_policy_with_listing' => 'سیاست بازپرداخت و بازپرداخت را در صفحه توضیحات محصول در قسمت جلو نمایش دهید.',
  'show_shop_desc_with_listing' => 'توضیحات فروشگاه را در صفحه توضیحات محصول در قسمت جلو نمایش دهید.',
  'shipping_zone_select_states' => 'اگر گزینه مورد نظر خود را نمی بینید ، احتمالاً بازار در آن منطقه عملیاتی نشده است. برای درخواست درخواست برای اضافه کردن منطقه می توانید با مدیر پشتیبانی بازار تماس بگیرید.',
  'marketplace_business_area' => 'منطقه تجاری بازار',
  'notify_new_chat' => 'هنگامی که پیام چت جدید وارد شد ، یک اعلان نامه الکترونیکی برای من ارسال کنید',
  'not_in_business_area' => 'این منطقه در منطقه فعال تجاری بازار نیست. شاید اخیراً توسط مدیر بازار حذف شده باشد.',
  'region_iso_code' => 'کد ISO منطقه باید درست باشد. برای کمک به بخش منطقه * تجارت * بخش اسناد را بخوانید.',
  'subscribers_count' => 'تعداد مشترکین فعال',
  'this_plan_has_active_subscribers' => 'این طرح به دلیل داشتن مشترکان فعال قابل حذف نیست.',
  'max_chat_allowed' => 'حداکثر :size کاراکتر',
  'mobile_slider_image' => 'تصویر کشویی برای برنامه تلفن همراه. در صورت عدم ارائه این سیستم ، این کشویی را بر روی موبایل پنهان می کند.',
  'config_can_cancel_order_within' => 'مشتریان پس از ثبت سفارش می توانند در این مدت سفارش را لغو کنند. آن را خالی نگه دارید تا لغو تا زمان تحقق سفارش مجاز باشد. 0 را تنظیم کنید تا گزینه لغو غیرفعال شود. هنوز هم مشتریان می توانند درخواست لغو را به فروشنده ارائه دهند.',
  'mobile_app_slider_hits' => 'نسبت 2: 1 را حفظ کنید',
  'enable_live_chat_on_platform' => 'در صورت فعال بودن ، فروشنده گزینه روشن / خاموش گپ زنده را در صفحه محصول و صفحه فروشگاه خود پیدا خواهد کرد.',
  'enable_live_chat_on_shop' => 'گفتگوی زنده را در صفحه محصول و صفحه فروشگاه خود فعال کنید.',
  'package_dependency_not_loaded' => 'وابستگی شکست خورد! این بسته به ماژول (های) :dependency بستگی دارد.',
  'option_dependence_module' => 'وابستگی شکست خورد! این گزینه وابسته ماژول :dependency است',
  'config_vendor_order_cancellation_fee' => 'هزینه انصراف هنگام فروشنده سفارش را لغو می کند. 0 را بدون هزینه لغو تنظیم کنید ، برای تنظیم هزینه سفارشی برای هر سفارش ، خالی نگه دارید (لغو نیاز به تأیید مدیر دارد)',
  'vendor_order_cancellation_fee' => 'هزینه لغو سفارش از فروشنده دریافت می شود.',
  'disabled_when_vendor_get_paid_directly' => 'هنگامی که فروشنده مستقیماً حقوق دریافت می کند ، نمی تواند فعال شود!',
  'confirm_uninstall_package' => 'تمام داده های مربوط به :package برای همیشه از بین می روند! نمی توانید این داده ها را برگردانید.',
  'verify_license_key' => 'ما در هنگام خرید کلید مجوز را به ایمیل شما ارسال کردیم. اگر آن را پیدا نکردید ، لطفا با جزئیات با پشتیبانی تماس بگیرید.',
  'promotional_tagline' => 'عنوان تبلیغاتی در ناوبری اصلی قرار می گیرد.',
  'best_finds_under' => 'این برای صفحه اصلی صفحه چرخشی <em> بهترین یافته ها در زیر </em> است. این سیستم در این محدودیت قیمت اقلام پرفروش را انتخاب خواهد کرد.',
  'featured_items' => 'این مربوط به قسمت صفحه اصلی <em> ویژه </em> است. پیشنهاد می کنیم 5-10 مورد تنظیم کنید.',
  'featured_categories' => 'این برای صفحه اصلی <em> بخش های برجسته </em> بخش است. ما پیشنهاد می کنیم 10-15 دسته را تنظیم کنید.',
  'trending_now_categories' => 'این برای صفحه اصلی <em> در حال حاضر دسته بندی </em> بخش است. ما پیشنهاد می کنیم 2-4 دسته را تنظیم کنید.',
  'featured_brands' => 'این برای صفحه اصلی <em> بخش های برجسته </em> بخش است. ما پیشنهاد می کنیم 3 علامت تجاری را تنظیم کنید.',
  'featured_vendors' => 'این برای بخش <em>فروشندگان ویژه</em> صفحه اصلی است. حداکثر 3 فروشنده می تواند برای این بخش انتخاب شود.',
  'slider_alternative_color' => 'این رنگ برای متن داخل برچسب دهانه استفاده خواهد شد.',
  'you_can_use_span_tag' => 'برای برجسته سازی کلمات مهم می توانید از برچسب <span> استفاده کنید.',
  'social_auth' => 'در صورت فعال بودن گزینه ورود به سیستم در صفحه ورود و ثبت نام مشتری نشان داده می شود',
  'slider_text_position' => 'موقعیت محتوای خود را روی کشویی تنظیم کنید. موقعیت پیش فرض درست است',
  'deal_of_the_day' => 'فقط یک مورد می تواند به عنوان معاملات روز تنظیم شود.',
  'show_merchant_info_as_vendor' => 'نمایش نام فروشنده و سایر اطلاعات در صفحه فهرست فروشنده و صفحه نمایه.',
  'pay_in_person' => 'اگر فعال شود، خود پیکاپ فعال خواهد بود.',
  'pay_online' => 'در صورت فعال کردن پرداخت آنلاین فعال خواهد بود.',
  'active_ecommerce' => 'در صورت فعال کردن، محصولات در جستجوی مشتری نشان داده می شوند.',
  'upload_package_zip_archive' => 'آپلود آرشیو ZIP حاوی فایل های بسته فقط. مستندات یا سایر فایل ها را آپلود نکنید.',
  'help_clear_cache' => 'Clear System Cache از جمله پیکربندی، تصاویر، مسیرها. این اقدام ممکن است پس از ایجاد برخی از تغییرات در فایل .env یا هر فایل پیکربندی نیاز داشته باشد. بلافاصله شما یک مرحله نهایی مسابقات را برای کمی متوجه خواهید شد، اما نگران نباشید، فقط فقط برای اولین بار است.',
  'this_will_overwrite_by_dynamic_commission' => 'هنگامی که پلاگین کمیسیون پویا فعال است این به ارزش پویا بازنویسی خواهد شد.',
  'transaction_fee_will_charge' => 'هزینه معامله حتی زمانی که کمیسیون صفر است، هزینه خواهد شد.',
  'show_item_conditions' => 'نمایش شرایط مورد (جدید، استفاده شده، مرمت شده). هنگامی که خاموش است، سیستم گزینه را از سراسر برنامه پنهان می کند.',
  'icon_size' => 'آیکون باید یک تصویر 32x32px .png باشد',
  'icon_image' => 'این تصویر آیکون در گروه دسته بندی گروهی به عنوان نماد گروه رده نشان داده می شود.',
  'changes_can_take_time' => 'تغییرات می تواند به :time برسد تا بر نتیجه تاثیر بگذارد.',
  'category_attributes' => 'فهرست ویژگی های پیوست شده به این دسته. این فیلدهای ویژگی در فرم ایجاد فهرست نشان داده خواهند شد.',
  'show_category_on_main_nav' => 'این دسته بندی به ناوبری اصلی تم جلو مرتبط می شود، آن را محدود نگه دارید.',
  'hide_item_from_main_nav' => 'این گزینه از پیمایش اصلی موضوع جلو حذف خواهد شد',
  'hide_technical_details_on_product_page' => 'جزئیات فنی را در صفحه محصول در قسمت جلویی مخفی کنید. مشتریان جزئیات فنی را در صفحه محصول مشاهده نخواهند کرد.',
  'hide_out_of_stock_items' => 'وقتی فعال شود، سیستم اقلام موجود در بازار را پنهان می کند. موارد بدون موجودی در نتایج جستجو، تبلیغات و هر فهرست دیگری قابل مشاهده نخواهند بود.',
  'shop_not_exist' => 'فروشگاه حذف یا غیرفعال شده است.',
  'trending_now_category_help' => 'برای نمایش بهتر حداکثر 5 دسته را اضافه کنید',
  'read_carefully' => 'با دقت بخوان!',
  'email_fill_notice' => 'ایمیل کارهای کاربردی زیادی مانند اعلان، فراموشی رمز عبور و غیره دارد، بنابراین سعی کنید این قسمت را پر کنید',
  'uninstall_license_incevio' => 'قبل از حذف مجوز از سیستم خود، باید نصب را از پورتال خود پشتیبانی incevio.com حذف کنید.',
  'uninstall_app_license' => 'حذف لایسنس به شما امکان می دهد دوباره نصب کنید. این کار نصب فعلی را باطل می کند و بلافاصله شما را به صفحه نصب هدایت می کند. برای جلوگیری از هرگونه مشکل پیش‌بینی نشده، لطفاً اگر در مکان دیگری نصب می‌کنید، پایگاه داده و فایل‌های نصب قدیمی را حذف کنید.',
  'cant_revert_action' => 'شما نمی توانید این عمل را برگردانید.',
  'update_app_license' => 'اگر آدرس IP سرور شما تغییر کرده باشد، مجوز را به روز می کند، بنابراین اسکریپت روی IP جدید به کار خود ادامه می دهد.',
  'reset_app_license' => 'حذف مجوز به شما امکان می دهد اسکریپت را مجدداً نصب کنید و نصب فعلی بلافاصله کار نمی کند. لطفاً فایل‌های نصب قدیمی را حذف کنید تا از مشکلات غیرمنتظره در نصب جدید جلوگیری کنید.<br/><b>شما نمی‌توانید این عملکرد را برگردانید.</b>',
  'need_help' => 'کمک خواستن؟ اینجا کلیک کنید',
  'warning' => 'هشدار',
  'regenerate_app_key' => 'کلیدهای مخفی را برای ایجاد یک کانال ارتباطی امن بین بازار و برنامه تلفن همراه خود برای به اشتراک گذاری اطلاعات حساس ایجاد کنید. این کلیدها در طول فرآیند ساخت اپلیکیشن موبایل بسیار مهم هستند. پس از ساخت و انتشار برنامه، لطفاً از تغییر این مقادیر برای جلوگیری از خرابی برنامه خودداری کنید.',
  'download_limit' => 'تعداد دفعاتی که می خواهید اجازه دانلود این محصول را برای هر مشتری پس از خرید بدهید، تنظیم کنید. اگر می خواهید به دانلود نامحدود اجازه دهید، آن را خالی نگه دارید',
];