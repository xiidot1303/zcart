      ...
      <div class="col-md-8 nopadding-left">
        <table class="table no-border">
          ...
          <tr>
            ...
            <td style="width: 60%;"><span class="label label-primary">{{ get_formated_currency($refund->amount, 2, config('system_settings.currency.id')) }}</span></td>
          </tr>
          <tr>
            <th class="text-right">{{ trans('app.order_amount') }}: </th>
            <td style="width: 60%;"><span class="label label-outline">{{ get_formated_currency($refund->order->total, 2, config('system_settings.currency.id')) }}</span></td>
          </tr>
          <tr>
