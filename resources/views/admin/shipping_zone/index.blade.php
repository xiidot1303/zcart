      ...
      <div class="row">
        ...
        @forelse($shipping_zones as $shipping_zone)
          <div class="col-xs-12">
            ...
            <span class="indent50">{{ $shipping_zone->tax->name . ' (' . $shipping_zone->tax->label . ')' }}</span>
                    ...
                    <li class="list-group-item">
                      ...
                      <p class="list-group-item-text">
                        ...
                        <span class="badge indent20">
                          {{ $shipping->rate > 0 ? get_formated_currency($shipping->rate, 2, config('system_settings.currency.id')) : trans('app.free') }}
                        </span>
                        @can('update', $shipping)
                          <small class="pull-right">
