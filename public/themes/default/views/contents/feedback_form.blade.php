    ...
    <div class="row">
      <div class="col-md-5 pl-1">
        <div class="well well-sm text-muted">
          <p class="lead text-center mb-1">@lang('theme.section_headings.how_to_give_feedbacks')</p>
          <p>@lang('theme.help.be_honest_when_leave_feedbacks')</p>
        </div>
              ...
              <td>
                ...
                <div class="product-info">
                  ...
                  @if ($order->shop->feedbacks->count())
                    @include('theme::layouts.ratings', ['ratings' => $order->shop->ratings, 'count' => $order->shop->ratings_count])
                  @else
